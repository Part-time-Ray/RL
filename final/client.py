...
if __name__ == '__main__':
    ...
    class PPOAgent:
        ...
        def act(self, observation):
            ...
            # action = action + np.random.normal([0.0, 0.0], [0.1, 0.05], size=action.shape)
            return action
    
    ppo_agent = PPOAgent(frame_stack=8, frame_skip=4, model_path='/mnt/nfs/work/ray/RL/final/Training/austria_competition/checkpoints/ppo_continue/ppo_continue_austria_best_13776000_steps.zip')
